...
data = {"weather":{"value":wea},"max_temperature":{"value":temperature},"love_day":{"value":get_count()},"birthday1":{"value":get_birthday()},"words":{"value":get_words(), "color":get_random_color()}}
